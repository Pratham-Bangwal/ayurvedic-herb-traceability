...
export default function QrScanner() {
  ...
  const startScanning = async () => {
    try {
      ...
      setError(`Camera access failed: ${err.message}. Try refreshing the page or checking camera permissions.`);
      setIsScanning(false);
      setIsLoading(false);
    }
  };
                    ...
                    {isMobile && (
                      <div style={{ 
                        ...
                        <p style={{ 
                          ...
                          🎯 Keep QR code within the camera frame<br/>
                    ...
                    {permissionDenied && (
                      <div className="camera-help" style={{ marginTop: '15px' }}>
                        ...
                        <ul style={{ margin: '10px 0', paddingLeft: '20px', textAlign: 'left' }}>
                          ...
                          <li><strong>Firefox:</strong> Click shield icon → Allow camera</li>
                          <li><strong>Safari:</strong> Safari → Preferences → Websites → Camera → Allow</li>
                          <li><strong>Edge:</strong> Click lock icon → Camera → Allow</li>
